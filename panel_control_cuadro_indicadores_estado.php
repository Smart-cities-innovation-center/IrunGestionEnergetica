...
<head>
	...
	<script type="text/javascript">
		function actualizar(){
			$('#divActualiza').load('panel_control_cuadro_indicadores_estado_actualiza.php?'+new Date().getTime()).fadeIn("slow");
		}
	...
	<section role="main" id="main">
		...
		<div class="with-padding" style="margin-bottom:30px;">
			...
			<p class="wrapped anthracite-gradient glossy with-mid-padding align-left" style="font-size:22px;">
				Panel de control Cuadro <? echo $vNumCuadro; ?> . Indicadores . Estado . <span class="orange"><? echo $vIndicadorSel; ?></span>
			</p>
			<br>
...
<!-- Pantalla principal Fin -->
	...
	<section id="menu" role="complementary">
		...
		<div id="menu-content">
            ...
            <section class="navigable">                   
                <ul class="big-menu">
                    <li><a href="panel_control_cuadro_indicadores_estado.php" class="current navigable-current">Estado</a></li>
                    <li>
