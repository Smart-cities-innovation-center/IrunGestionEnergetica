	...
	<section role="main" id="main">
		...
		<div class="with-padding" style="margin-bottom:30px;">
			...
			<p class="wrapped anthracite-gradient glossy with-mid-padding align-left" style="font-size:22px;">
				Panel de control Cuadro <? echo $vNumCuadro; ?> . <span class="orange">Alumbrado</span>
			</p>
			<br><br>
...
<div class="container_16">
			<article class="grid_16">
				...
				<div class="content gradient_mapa rounded light shadow">  
					...
					$listaCircuitos = array(); $i = 0;
					$BDCuadrosCircuitos = mysql_query("SELECT * FROM tCuadrosCircuitos 
																WHERE cuacirNumCuadro=$vNumCuadro 
																ORDER BY cuacirNumero");
					while($rowBDCuadrosCircuitos = mysql_fetch_array($BDCuadrosCircuitos)) {
						echo "<script>tipo[".$i."]='Circuito ".$rowBDCuadrosCircuitos['cuacirNumero']."';</script>";
						echo "<script>images[".$i."]='img/proyecto/iconos/icoAlumbradoCircuito".$rowBDCuadrosCircuitos['cuacirNumero'].".png';</script>";
						$i++;					
					}
					
					$BDCuadrosServicios = mysql_query("SELECT * FROM tCuadrosServicios 
																WHERE cuaserNumero=$vNumCuadro 
																AND cuaserTipo='Alumbrado'
                                ...
                                <span class="geo">
                                    ...
                                    <span class="icono">
                                        <span class="value-title" 
                                        	title="img/proyecto/iconos/<? echo $rowBDCuadrosServicios['cuaserIcono']."Circuito".$rowBDCuadrosServicios['cuaserCircuitoNum'].".png"; ?>" >
                                        </span>
                                    </span>
                                    <span class="tipo">
                                        <span class="value-title" title="Circuito <? echo $rowBDCuadrosServicios['cuaserCircuitoNum']; ?>" ></span>
                                    </span>                                                                 
                                </span>                             
                           </div>
                        </div>                     											
