...
<head>
	...
	<script type="text/javascript">
		function actualizar(){
			$('#divActualiza').load('panel_control_cuadro_riego_telecontrol_actualiza.php?'+new Date().getTime()).fadeIn("slow");
		}
	...
	<section role="main" id="main">
		...
		<div class="with-padding" style="margin-bottom:30px;">
			...
			<p class="wrapped anthracite-gradient glossy with-mid-padding align-left" style="font-size:22px;">
				Panel de control Cuadro <? echo $vNumCuadro; ?> . Riego . <span class="orange">Telecontrol válvulas</span>
			</p>
			<br>
		...
		<div id="menu-content">
            ...
            <section class="navigable">                   
                <ul class="big-menu">
                    ...
                    <li><a href="panel_control_cuadro_riego_estado.php">Estado circuito control</a></li>
                    <li><a href="#" class="current navigable-current">Telecontrol válvulas</a></li>
