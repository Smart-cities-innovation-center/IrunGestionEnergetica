	...
	<section role="main" id="main">
		...
		<div class="with-padding" style="margin-bottom:30px;">
			...
			<p class="wrapped anthracite-gradient glossy with-mid-padding align-left" style="font-size:22px;">
				Alarmas . Históricos . <span class="orange">Cuadro 153</span>
			</p>
			<br>
			...
			<div class="with-padding">
                ...
                <div align="center">
					<p class="big-message black-gradient green-color" style="width:50%; text-align:center">
						...
						<strong style="font-size:14px">No existen registros de alarmas en el Cuadro 153</strong>
					</p>
                </div>
                <br /><br /><br /><br /><br /><br />
		...
		<div id="menu-content">
			...
			<section class="navigable">
                <ul class="big-menu">
                    ...
                    <li><a href="#" class="current navigable-current">Cuadro 153</a></li>
                </ul>
			</section>         
