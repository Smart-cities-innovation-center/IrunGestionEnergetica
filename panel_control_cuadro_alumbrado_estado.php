...
<head>
	...
	<script type="text/javascript">
		function actualizar(){
			$('#divActualiza').load('panel_control_cuadro_alumbrado_estado_actualiza.php?'+new Date().getTime()).fadeIn("slow");
		}
	...
	<section role="main" id="main">
		...
		<div class="with-padding" style="margin-bottom:30px;">
			...
			<p class="wrapped anthracite-gradient glossy with-mid-padding align-left" style="font-size:22px;">
				Panel de control Cuadro <? echo $vNumCuadro; ?> . Alumbrado . <span class="orange">Estado monitorizadas</span>
			</p>
			<br>
		...
		<div id="menu-content">
            ...
            <section class="navigable">                   
                <ul class="big-menu">
                    ...
                    <li><a href="#" class="current navigable-current">Estado monitorizadas</a></li>
