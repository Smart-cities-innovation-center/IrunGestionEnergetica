	...
	<section role="main" id="main">
		...
		<div class="with-padding" style="margin-bottom:30px;">
			...
			<p class="wrapped anthracite-gradient glossy with-mid-padding align-left" style="font-size:22px;">
				Alarmas . <span class="orange">Configuración</span>
			</p>
			<br>
			...
			<table class="table responsive-table" id="sorting-advanced">
				...
				<tbody>
                        <tr>
                            ...
                            <td>Falta cominicación con placa de control</td>
                        ...
                        <tr>
                            <td class="align-center">003</td>
                            <td>Falta de tensión por robo de cable</td>
                            <td class="low-padding align-center">
                            	<a href="#" 
                                	class="button icon-pencil with-tooltip" title="Modificar"></a>
                                &nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            <td class="align-center">004</td>
                            <td>Baja potencia o luminaria parpadeante</td>
                            <td class="low-padding align-center">
                            	<a href="#" 
                                	class="button icon-pencil with-tooltip" title="Modificar"></a>
                                &nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            <td class="align-center">007</td>
                            <td>Alteración significativa de consumo</td>
                            <td class="low-padding align-center">
                            	<a href="#" 
                                	class="button icon-pencil with-tooltip" title="Modificar"></a>
                                &nbsp;&nbsp;&nbsp;
