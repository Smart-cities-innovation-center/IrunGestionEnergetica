	...
	<section role="main" id="main">
		...
		<div class="with-padding" style="margin-bottom:30px;">
			...
			<p class="wrapped anthracite-gradient glossy with-mid-padding align-left" style="font-size:22px;">
				Alarmas . <span class="orange">Activas</span>
			</p>
			<br>
...
<!-- Pantalla principal Inicio -->
			...
			<table class="table responsive-table" id="sorting-advanced">
				...
				<thead>
					<tr>
						<th scope="col" class="align-center" width="15%">Fecha</th>
                        ...
                        <th scope="col" class="align-center" width="12%"> </th>
					</tr>
				</thead>
                
				<tbody>
                        <tr>
                            <td class="align-center">2014-06-19 07:35</td>
                            <td class="align-center">047</td>
                            <td class="align-center">047-011</td>
                            <td>Baja potencia o luminaria parpadenate</td>
                            <td><small class="tag red-bg" style="font-size:12px;">activa</small></td>
                            <td>
                                <button class="button compact glossy">
                                    <span class="button-icon orange-gradient"><span class="icon-question"></span></span>
                                </button>
                                &nbsp;&nbsp;
                                <button class="button compact glossy">
                        ...
                        <tr>
                            <td class="align-center">2014-06-17 10:45</td>
                            <td class="align-center">047</td>
                            <td class="align-center">047-013</td>
                            <td>Falta de corriente por fallo de lámpara</td>
                            <td><small class="tag orange-bg" style="font-size:12px;">comprobando</small></td>
                            <td>
                            	<button class="button compact glossy">
                                    <span class="button-icon red-gradient"><span class="icon-question"></span></span>
                                </button>
                                &nbsp;&nbsp;
                                <button class="button compact glossy">
                                    <span class="button-icon green-gradient"><span class="icon-tick"></span></span>
                        ...
                        <tr>
                            <td class="align-center">2014-06-17 06:15</td>
                            <td class="align-center">048</td>
                            <td class="align-center">048-032</td>
	...
	<section id="menu" role="complementary">
		...
		<div id="menu-content">
			...
			<section class="navigable">
                <ul class="big-menu">
					<li><a href="#" class="current navigable-current">Activas</a></li>
                    <li class="with-right-arrow"><a href="panel_alarmas_historicos_completo.php">Históricos</a></li>
                    <li><a href="panel_alarmas_informes.php">Informes</a></li> 
