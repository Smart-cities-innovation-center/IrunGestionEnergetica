                    ...
                    <table class="table responsive-table" id="sorting-advanced">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="3">
                                    <?
                                        $result = mysql_query("SELECT * FROM tCuadrosRiegoTelecontrol
																	WHERE cuarietelNumero=$vNumCuadro");
                        ...
                        <tbody>
                            <?
                                $bdCuadrosRiegoTel = mysql_query("SELECT * FROM tCuadrosRiegoTelecontrol
																WHERE cuarietelNumero=$vNumCuadro
																ORDER BY cuarietelId");
                                while ($rowCuaRieTel = mysql_fetch_array($bdCuadrosRiegoTel)){
									$auxCuaIdRiego = $rowCuaRieTel['cuarietelCuaIdRiego'];
									$auxEstado = $rowCuaRieTel['cuarietelEstado'];
									$auxCanalEstado = $rowCuaRieTel['cuarietelCanalEstado'];
									...
									$bdCuaRiego = mysql_query("SELECT * FROM tCuadrosRiego
																WHERE cuarieId=$auxCuaIdRiego");
									$rowCuaRie = mysql_fetch_array($bdCuaRiego);						
						
                                ?>
                                <tr>
                                    <td class="align-center" style="vertical-align:middle;"><? echo $rowCuaRie['cuarieNumRef']; ?></td>
                                    <td style="vertical-align:middle;"><? echo utf8_encode($rowCuaRie['cuarieDireccion']); ?></td>
                                    <td class="align-center" style="vertical-align:middle;">
                                        <span class="button-group">
                                            <label for="button-radio-1" class="button green-active">
                                                <input type="radio" name="fEstado-<? echo $rowCuaRie['cuarieNumRef']; ?>" 
                                                	id="fEstado-<? echo $rowCuaRie['cuarieNumRef']; ?>-1"
                                            ...
                                            <label for="button-radio-2" class="button red-active">
                                                <input type="radio" name="fEstado-<? echo $rowCuaRie['cuarieNumRef']; ?>" 
                                                	id="fEstado-<? echo $rowCuaRie['cuarieNumRef']; ?>-2"
