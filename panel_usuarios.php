	...
	<section role="main" id="main">
		...
		<div class="with-padding" style="margin-bottom:30px;">
			...
			<p class="wrapped anthracite-gradient glossy with-mid-padding align-left" style="font-size:22px;">
				Gestión de usuarios . <span class="orange">Usuarios</span>
			</p>
			<br>
			...
			<table class="table responsive-table" id="sorting-advanced">
				...
				<thead>
					<tr>
                        ...
                        <th scope="col" class="align-center">Acceso a...</th>
				...
				<tbody>
                	<?
                        ...
                        <tr>
                            ...
                            <td><? echo $rowUsuarios['usuUsuario']; ?></td>
                            <td>&bull;&bull;&bull;&bull;&nbsp;oculto&nbsp;&bull;&bull;&bull;&bull;</td>
                            <td><? echo $rowUsuarios['usuEmail']; ?></td>
                            <td align="center">
							<input type="checkbox" name="fEstado" id="fEstado" class="switch tiny mid-margin-right" 
                                value=<? echo $rowUsuarios['usuEstado']; ?> 
                                <? if ($rowUsuarios['usuEstado']) { echo "checked"; } ?>
								data-text-on=" " data-text-off=" " disabled> 
							</td>
                            <td>
                            	<? if ($rowUsuarios['usuServiciosAlumbrado']) {?><small class="tag orange-bg">Alumb</small> <? } ?>
                                <? if ($rowUsuarios['usuServiciosRiego']) {?><small class="tag blue-bg">Riego</small> <? } ?>
                                <? if ($rowUsuarios['usuServiciosAccesos']) {?><small class="tag red-bg">Acces</small> <? } ?>
                                <? if ($rowUsuarios['usuServiciosIndicadores']) {?><small class="tag green-bg">Indic</small> <? } ?>
                            </td>
                            <td class="low-padding align-center">
                            	<a href="panel_usuarios_editar.php?id=<? echo $rowUsuarios['usuIdUsuario']; ?>" 
                                	class="button icon-pencil with-tooltip" title="Modificar"></a>
                                <a href="#" 
                                	class="button icon-trash with-tooltip confirm" title="Borrar"></a>
                            </td>
                        </tr> 
                        <?
						}
	...
	<section id="menu" role="complementary">
		...
		<div id="menu-content">
			...
			<section class="navigable">
                <ul class="big-menu">
					<li><a href="#" class="current navigable-current">Usuarios</a></li>
